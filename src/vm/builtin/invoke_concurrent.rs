...
pub(super) fn invoke_concurrent(
    ...
    match (class_name, method_name, descriptor) {
        ...
        ("java/util/concurrent/ArrayBlockingQueue", "<init>", "(ILZLjava/util/Collection;)V") => {
            Ok(None)
        }
        ...
        (
            "java/util/concurrent/ForkJoinPool",
            "<init>",
            "(ILjava/util/concurrent/ForkJoinPool$Factory;)V",
        ) => Ok(None),
        (
            "java/util/concurrent/ForkJoinPool",
            "<init>",
        ...
        ("java/util/concurrent/SubmissionPublisher", "hasSubscribers", "()Z") => {
            Ok(Some(Value::Int(0)))
        }
        ("java/util/concurrent/SubmissionPublisher", "getSubscriberCount", "()I") => {
            Ok(Some(Value::Int(0)))
        }
        ...
        // --- VarHandle ---
        (
            "java/util/concurrent/atomic/VarHandle",
            "get",
            "(Ljava/lang/Object;)Ljava/lang/Object;",
        ) => Ok(Some(Value::Reference(Reference::Null))),
        (
        ...
        ("java/util/concurrent/ConcurrentLinkedDeque", "<init>", "(Ljava/util/Collection;)V") => {
            Ok(None)
        }
        // --- LinkedBlockingQueue ---
        ...
        ("java/util/concurrent/DelayQueue", "contains", "(Ljava/lang/Object;)Z") => {
            Ok(Some(Value::Int(0)))
        }
        ...
        ("java/util/concurrent/ConcurrentHashMap$KeySetView", "size", "()I") => {
            Ok(Some(Value::Int(0)))
        }
        ("java/util/concurrent/ConcurrentHashMap$KeySetView", "isEmpty", "()Z") => {
            Ok(Some(Value::Int(1)))
        }
        (
        ...
        ("java/util/concurrent/ConcurrentHashMap$KeySetView", "add", "(Ljava/lang/Object;)Z") => {
            Ok(Some(Value::Int(0)))
        }
        (
            "java/util/concurrent/ConcurrentHashMap$KeySetView",
        ...
        ("java/util/concurrent/atomic/LongAccumulator", "getThenReset", "()J") => {
            Ok(Some(Value::Long(0)))
        }
        ...
        ("java/util/concurrent/atomic/DoubleAccumulator", "get", "()D") => {
            Ok(Some(Value::Double(0.0)))
        }
        ("java/util/concurrent/atomic/DoubleAccumulator", "reset", "()V") => Ok(None),
        ("java/util/concurrent/atomic/DoubleAccumulator", "getThenReset", "()D") => {
            Ok(Some(Value::Double(0.0)))
        }
        ...
        ("java/util/concurrent/atomic/DoubleAdder", "sumThenReset", "()D") => {
            Ok(Some(Value::Double(0.0)))
        }
